...
if (!class_exists('RGC_CMB2_Tabs')) {
    ...
    class RGC_CMB2_Tabs
    {
        ...
        {
            wp_register_script('cmb-tabs', get_template_directory_uri() . '/inc/cmb2/tabs/js/tabs.js', array('jquery'), self::VERSION, true);
            wp_enqueue_script('cmb-tabs');

            wp_enqueue_style('cmb-tabs', get_template_directory_uri() . '/inc/cmb2/tabs/css/tabs.css', array(), self::VERSION);
        ...
        {
            wp_enqueue_style('cmb-tabs-dark-mode', et_template_directory_uri() . '/inc/cmb2/tabs/css/dark-mode.css', array(), self::VERSION);
