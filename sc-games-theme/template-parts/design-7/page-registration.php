...
<div class="modal-overlay">
    <div class="modal-window">
        <div class="modal-close">
            <img src="<?php echo get_template_directory_uri() ?>/assets/design-7/img/close.svg" alt="star">
        </div>
        <div class="modal-content">
            <div class="modal-title"><?php echo !empty($answer_text) ? $answer_text : 'Thank you for your message!'; ?></div>
            <div class="button"><span><?php echo !empty($answer_button_label) ? $answer_button_label : 'Ok'; ?></span></div>
        </div>
    </div>
</div>