...
<main>
  ...
  <section class="games">
    <div class="container">
      <div class="games-block">
        ...
        if (!empty($games)) {
          echo '<div class="swiper-container"><div>';
          echo '<div class="games-card-list swiper">';
          echo '<div class="swiper-wrapper">';
          foreach ($games as $key => $game) {
            $rating = get_post_meta($game->ID, 'game_page__rating', true);
            $percent = $rating * 10;
            echo '<div class="game-card swiper-slide">';
  ...
  <section class="newsletter">
    <div class="container">
      <div class="subscribe">
        <img src="<?php echo get_template_directory_uri() . '/assets/design-19/img/mail-box.png' ?>"
             alt="">
        <div class="wrapper">
