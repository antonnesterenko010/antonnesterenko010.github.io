...
?>
<!-- swiper -->
<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/design-20/css/swiper-bundle.min.css' ?>" />
<script src="<?php echo get_template_directory_uri() . '/assets/design-20/js/swiper-bundle.min.js' ?>"></script>
