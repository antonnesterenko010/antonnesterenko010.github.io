...
<section id="modalRegister" class="modal">
                        ...
                        <div class="form-block">
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input class="input" type="text" id="r_name" name="r_name">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="label-wrapper required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input class="input" type="text" id="r_email" name="r_email">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="label-wrapper required">
...
<section id="modalContact" class="modal">
    <div class="modal-wrapper">
        <div class="modal-form content__form contact">
            <div class="modal-container">
                <div class="content-block">
                    <div class="content-title main-title-big"><?php echo !empty($cont_title_label) ? $cont_title_label : 'Contact Us'; ?></div>
                    <a id="form_anchor"></a>
                        ...
                        <div class="form-block-wrapper">
                            ...
                            <div class="form-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <textarea class="input" name="r_textarea" id="" cols="30" rows="10"></textarea></div>
                                </div>
                            </div>
                        </div>
                        <div class="submit-block">
                            <input type="submit" class="form-submit-btn main-button"
                                   value="<?php echo !empty($cont_submit_label) ? $cont_submit_label : 'Send'; ?>">
                        </div>
                    </form>
                </div>
            </div>
...
<div class="modal-overlay">
    <div class="modal-window">
        ...
        <div class="modal-content">
            ...
            <div class="modal-btn button main-button"><?php echo !empty($answer_button_label) ? $answer_button_label : 'Ok'; ?></div>
        </div>
    </div>
</div>
<footer class="footer">
        ...
        <div class="container">
            <div class="footer-block">
                <div class="subscribe footer-form-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/design-24/img/footer-machine.png" alt="slot machine">
                    <div class="wrapper">
                ...
                <div class="footer-block-wrapper">
                    ...
                    if (!empty($footer_col1) || !empty($footer_col2) || !empty($footer_col3)) {
                        ...
                        echo '<img class="footer-description-image" src="' . get_template_directory_uri() . '/assets/design-24/img/footer-chips.png" alt="Casino chips">';
                        echo '</div>';
                        echo '</div>';
