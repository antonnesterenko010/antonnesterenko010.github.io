            ...
            <div class="header-mobile">
                <div class="header-block">
                    <div class="header-top">
                        <?php
                        if (!empty($logo)) {
                            echo '<a href="' . get_site_url() . '" class="header-logo"><img src="' . $logo . '" alt="Logo" width="193" height="29"></a>';
                        }
                        ?>
                    ...
                    <div class="header-bottom">
                        ...
                        if (!empty($reg_link) && !empty($reg_label)) {
                            echo '<div class="header-button header-sign-up"><a href="' . $reg_link . '" class="main-button">' . $reg_label . '';
                            echo '</a></div>';
                        }
                        ?>
                    </div>
