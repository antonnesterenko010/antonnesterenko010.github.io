        ...
        <div class="container">
            <div class="hero-block">
                ...
                <div class="hero-image-wrapper">
                    <img class="hero-desktop-img" src="<?php echo get_template_directory_uri() . '/assets/design-35/img/hero-image.png' ?>"
                         alt="">
                    <img class="hero-mobile-img" src="<?php echo get_template_directory_uri() . '/assets/design-35/img/hero-image-mobile.png' ?>"
                         alt="">
                </div>
            </div>
        </div>
