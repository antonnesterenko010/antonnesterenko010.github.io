    ...
    <div class="container">
        <div class="hero-block">
            ...
            <div class="hero-image-wrapper">
                <img src="<?php echo get_template_directory_uri() . '/assets/design-16/img/hero-image.png' ?>"
                     alt="hero-image">
            </div>
        </div>
    </div>
            ...
            <div class="newsletter-block-wrapper">
                <div class="newsletter-content">
                    ...
                    <form action="#" class="newsletter-form">
                        ...
                        <?php echo '<button type="submit" class="newsletter-button"><img src="' . get_template_directory_uri() . '/assets/design-16/img/newsletter-button.svg" alt="newsletter-button"></button>'; ?>
                    </form>
                </div>
            </div>
        </div>
