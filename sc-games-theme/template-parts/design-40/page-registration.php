        ...
        <div class="form-wrapper">
          ...
          <form method="POST" action="#form_anchor">
            ...
            <div class="submit-block">
                <button type="submit" class="submit-btn btn"><span><?php echo !empty($submit_label) ? $submit_label : 'Submit'; ?></span></button>
            </div>
          </form>
        </div>
      </div>
            ...
            <div class="modal-window">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-btn btn">
                        <span><?php echo !empty($answer_button_label) ? $answer_button_label : 'Close'; ?></span>
                    </div>
                </div>
            </div>
        </div>
