...
<!--                    <div class="header-button hero-reg-button"><span class="main-button">--><?php //= $reg_label ?><!--</span></div>-->
<!--                </div>-->
            </div>
        ...
        <div class="newsletter-block">
            <div class="newsletter-block-wrapper">
                <div class="newsletter-image">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-30/img/newsletter-decor.png'?>" alt="">
                </div>
