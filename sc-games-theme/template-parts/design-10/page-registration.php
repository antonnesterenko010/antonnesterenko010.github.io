    ...
    <div class="modal-overlay">
        <div class="modal-window">
            ...
            <div class="modal-content">
                ...
                <div class="modal-btn"><?php echo !empty($answer_button_label) ? $answer_button_label : 'Ok'; ?></div>
                <div class="decor"><img src="<?php echo get_template_directory_uri() ?>/assets/design-10/img/popup-img.png" alt="popup-decor"></div>
            </div>
        </div>
    </div>
</div>