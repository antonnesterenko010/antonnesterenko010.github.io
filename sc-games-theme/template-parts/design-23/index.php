    ...
    <div class="container">
        <div class="hero-block">
            <div class="hero-title-wrapper">
                ...
                echo !empty($index_data['hero_description']) ? '<div class="hero-description main-title-medium">' . $index_data['hero_description'] . '</div>' : '';
                ?>
                <div class="hero-button-wrapper">
                    <div class="header-button hero-reg-button"><span class="main-button"><?= $reg_label ?></span></div>
                    <div class="header-button hero-contact-button"><span class="main-button"><?= $contact_label ?></span></div>
                </div>
            </div>
            <div class="hero-image-wrapper">
                <img src="<?php echo get_template_directory_uri() . '/assets/design-23/img/hero-image-desktop.png'?>" alt="">
            </div>
        </div>
        <a href="#games-section" class="hero-arrow">
            <img src="<?php echo get_template_directory_uri() . '/assets/design-23/img/arrow-down.svg'?>" alt="down-arrow">
        </a>
    </div>
</section>
