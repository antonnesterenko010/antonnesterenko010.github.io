        ...
        <div class="container">
            <div class="footer-block subscribe">
                <div class="subscribe-img">
                    <img class="subscribe-bottom" src="<?php echo get_template_directory_uri(); ?>/assets/design-37/img/newsletter-bottom-layer.svg" alt="">
                    <img class="subscribe-upper" src="<?php echo get_template_directory_uri(); ?>/assets/design-37/img/newsletter-upper-layer.svg" alt="">
                </div>
                <div class="wrapper">
