<?php $game_data = get_game_page_data(get_the_ID()); ?>
    <section class="page__content">
        <div class="container">
            <div class="single-game-decor">
                <div class="single-game-decor-item ball">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/decor-ball.png'?>" alt="">
                </div>
                <div class="single-game-decor-item sparkle sparkle-big">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/decor-sparkle-big.png'?>" alt="">
                </div>
                <div class="single-game-decor-item sparkle sparkle-small">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/decor-sparkle-small.png'?>" alt="">
                </div>
            </div>
