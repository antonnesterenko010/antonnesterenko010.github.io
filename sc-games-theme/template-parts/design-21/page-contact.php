...
<section class="content__form contact">
    <div class="contact-decor">
        <div class="contact-decor-item earth">
            <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/earth.png'?>" alt="contact-decor">
        </div>
        <div class="contact-decor-item meteor">
            <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/meteor-2.png'?>" alt="contact-decor">
        </div>
        <div class="contact-decor-item star">
            <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/star-2.png'?>" alt="contact-decor">
        </div>
    </div>
    <div class="container">
        <div class="content-block">
            ...
            <form class="" method="POST" action="#form_anchor">
                <div class="form-decor">
                    <div class="form-decor-item sparkle-big">
                        <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/sparkle-big-2.png'?>" alt="contact-decor">
                    </div>
                    <div class="form-decor-item sparkle-small">
                        <img src="<?php echo get_template_directory_uri() . '/assets/design-21/img/sparkle-small-2.png'?>" alt="contact-decor">
                    </div>
                </div>
