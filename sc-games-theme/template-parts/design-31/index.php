    ...
    <div class="container">
        <div class="hero-block">
            ...
            <div class="hero-image-wrapper">
                <div class="hero-clown">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-31/img/hero-image.png' ?>"
                         alt="hero-image">
                </div>
                <div class="hero-gold">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-31/img/hero-image-2.png' ?>"
                         alt="hero-image">
                </div>
            </div>
        </div>
