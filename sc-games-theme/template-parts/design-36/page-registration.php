        ...
        <div class="content-block">
            ...
            <form class="form-with-answer" method="POST" action="#form_anchor">
                <div class="form-block">
                    ...
                    <div class="form-group">
                        <div class="label-wrapper required">
                            <label for="r_name"><?php echo !empty($password_label) ? $password_label : 'Password'; ?></label>
                        </div>
                        <div class="input-wrapper">
                    ...
                    <div class="form-group">
                        <div class="label-wrapper required">
                            <label for="r_name"><?php echo !empty($email_label) ? $email_label : 'Email'; ?></label>
                        </div>
                        <div class="input-wrapper">
                    ...
                    <div class="form-group">
                        <div class="label-wrapper required">
                            <label for="r_name"><?php echo !empty($password_again_label) ? $password_again_label : 'Password again'; ?></label>
                        </div>
                        <div class="input-wrapper">
