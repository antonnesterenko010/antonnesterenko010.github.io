        ...
        <div class="wrapper">
          <div class="<?php echo $index_data['hero_reg_link'] ?>">
            ...
            if (!empty($index_data['hero_button_link'])) {
              echo '<div class="header-sign"><a href="' . $index_data['hero_button_link'] . '" class="btn">' . (!empty($index_data['hero_button_label']) ? $index_data['hero_button_label'] : 'Register') . '</a></div>';
            }
            ?>
          </div>
          <?php
