    ...
    <div class="container">
        <div class="hero-block">
            <div class="hero-title-wrapper">
                ...
                if (!empty($index_data['hero_button_link'])) {
                    echo '<div class="hero-reg-button"><a href="' . $index_data['hero_button_link'] . '" class="main-button">' . (!empty($index_data['hero_button_label']) ? $index_data['hero_button_label'] : 'Register') . '</a></div>';
                }
                ?>
            </div>
