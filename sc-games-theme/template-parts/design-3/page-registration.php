        ...
        <div class="content-block">
            ...
            <form class="form-with-answer" method="POST" action="#form_anchor">
                ...
                <div class="submit-block">
                    <input type="submit" class="form-submit-btn submit-btn button"
...
<div class="modal-overlay">
    <div class="modal-window">
        <div class="modal-close">
            <img src="<?php echo get_template_directory_uri() ?>/assets/design-3/img/close.svg" alt="star">
        </div>
        <div class="modal-content">
            <div class="modal-title"><?php echo !empty($answer_text) ? $answer_text : 'Thank you for your message!'; ?></div>
            <div class="modal-btn btn"><div class="name"><?php echo !empty($answer_button_label) ? $answer_button_label : 'Ok'; ?></div></div>
        </div>
    </div>
</div>