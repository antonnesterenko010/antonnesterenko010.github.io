        ...
        <div class="games-block">
            ...
            if (!empty($games)) {
                ...
                foreach ($games as $game) {
                    ...
                    echo '</div><a class="card-button" href="' . get_permalink($game->ID) . '"><img src="' . get_template_directory_uri() . '/assets/design-1/img/play-btn.svg' . '" alt=""></a>';
                    echo '</div></div></div>';
                }
                echo '</div>';
            }
    ...
    <div class="container">
        <div class="newsletter-block">
            <div class="newsletter-decor">
                <img src="<?php echo get_template_directory_uri() . '/assets/design-1/img/' ?>newsletter-decor.png"
