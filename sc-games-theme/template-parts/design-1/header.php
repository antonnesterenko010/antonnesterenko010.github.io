...
<div class="page-wrap">
    <div class="page-bg">
        <div class="hero-bg">
            <img src="<?php echo get_template_directory_uri() . '/assets/design-1/img/2-header-bg.png'; ?>"
                 alt="hero-bg">
        </div>
        <div class="page-content-bg"></div>
        <div class="footer-bg">
            <img src="<?php echo get_template_directory_uri() . '/assets/design-1/img/2-footer-bg.png'; ?>"
                 alt="footer-bg">
        </div>
    </div>
