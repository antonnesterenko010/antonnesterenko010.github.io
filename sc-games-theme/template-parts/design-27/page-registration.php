    ...
    <div class="container">
        <div class="content-block register">
                ...
                <form class="form-with-answer" method="POST" action="#form_anchor">
                    <div class="form-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" placeholder="<?php echo !empty($password_again_label) ? $password_again_label : 'Password again'; ?>" id="r_pass_confirm" name="r_pass_confirm">
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-image">
                <img src="<?php echo get_template_directory_uri() . '/assets/design-27/img/reg-form-image.png'?>" alt="">
            </div>
        </div>
    </div>
</section>
