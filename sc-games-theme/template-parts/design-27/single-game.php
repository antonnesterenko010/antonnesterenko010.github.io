            ...
            <div class="page__content-wrapper">
                ...
                <div class="page__content-window">
                    ...
                    if (!empty($game_data['game_link'])) {
                        ...
                        echo '<div class="game-button"><img src="'. get_template_directory_uri() . '/assets/design-27/img/play-button.svg' .' " alt=""></div>';
                ...
                <div class="related-posts">
                    ...
                    if (!empty($games)) {
                        ...
                        foreach ($games as $game) {
                            ...
                            echo '<div class="button-wrapper"><a href="' . get_permalink($game->ID) . '" class="card-button main-button">' . $game_data['play_btn'] . '</a></div>';
                            echo '</div>';
                            echo '</div></div></div>';
                        }
                        echo '</div></div>';
