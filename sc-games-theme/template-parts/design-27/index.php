...
$play_btn = isset($options['sc_games_pln_btn']) && !empty($options['sc_games_pln_btn']) ? $options['sc_games_pln_btn'] : '';
    ...
    <div class="container">
        <div class="hero-block">
            ...
            <div class="hero-image-wrapper">
                <img src="<?php echo get_template_directory_uri() . '/assets/design-27/img/hero-right-image-desktop.png'?>" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="newsletter-block">
            <div class="newsletter-block-wrapper">
                <div class="newsletter-image">
                    <img src="<?php echo get_template_directory_uri() . '/assets/design-27/img/newsletter-image-desktop.png'?>" alt="">
                </div>
