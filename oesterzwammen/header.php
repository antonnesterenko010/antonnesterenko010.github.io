...
$registerMainHeader = new RegisterMenus('Main Header', 'oesterz');
...
<head>
    ...
    <link rel="manifest" href="<?php echo get_template_directory_uri() ?>/dest/favicons/site.webmanifest">
    <link rel="mask-icon" href="<?php echo get_template_directory_uri() ?>/dest/favicons/safari-pinned-tab.svg" color="#5bbad5">
