...
jQuery(function ($) {
    $(document).ready(function () {
        ...
        var counter = $('.gallery-slider__module .owl-counter');
        ...
        owlCarouselGallery.imagesLoaded(function () {
            ...
            $('.gallery-slider__module .owl-prev').click(function() {
                owlCarouselGallery.trigger('prev.owl.carousel');
            });

            $('.gallery-slider__module .owl-next').click(function() {
                owlCarouselGallery.trigger('next.owl.carousel');
            });

            function updateCounter(event) {
                var currentItem = (event.item.index % event.item.count) + 1;
                counter.text(currentItem + '/' + event.item.count);
            }
